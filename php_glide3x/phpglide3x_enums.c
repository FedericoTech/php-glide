...
void phpglide3x_register_enums(INIT_FUNC_ARGS)
{
	...
	//typedef FxI32 GrChromaRangeMode_t;
	grChromaRangeMode_ce = register_class_GrChromaRangeMode_t();
	...
	//typedef FxI32 GrTexChromakeyMode_t;
	grTexChromakeyMode_ce = register_class_GrTexChromakeyMode_t();
	...
	*/
	...
	//typedef FxU32 GrEnableMode_t;
	grEnableMode_ce = register_class_GrEnableMode_t();
	...
	//typedef FxU32 GrCoordinateSpaceMode_t;
	grCoordinateSpaceMode_ce = register_class_GrCoordinateSpaceMode_t();

	CREATE_CONSTANT(GR_WINDOW_COORDS);
	CREATE_CONSTANT(GR_CLIP_COORDS);

	/* Types of data in strips */
	grDataStrips_ce = register_class_GrDataStrips_t();

	CREATE_CONSTANT(GR_FLOAT);
	CREATE_CONSTANT(GR_U8);

	/* Parameters for strips */
	grParams_ce = register_class_GrParams_t();
	...
	//typedef FxU32 GrEnableMode_t;
	grMode_ce = register_class_GrMode_t();

	CREATE_CONSTANT(GR_PARAM_DISABLE);
	CREATE_CONSTANT(GR_PARAM_ENABLE);

	//grDrawVertexArray/grDrawVertexArrayContiguous primitive type
	grVertex_ce = register_class_GrVertex_t();
	...
	//grGet/grReset types
	grGet_ce = register_class_GrGet_t();
	...
	//grGetString types
	grString_ce = register_class_GrString_t();
